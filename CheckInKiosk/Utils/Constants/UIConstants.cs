...
namespace CheckInKiosk.Utils.Constants
{
    public static class UIConstants
    {
        ...
        public static readonly string Haarcascade_Sunglasses_Path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "haarcascade_eye_tree_eyeglasses.xml");
        public static readonly string Haarcascade_Mask_Path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "haarcascade_mcs_mouth.xml");
        public static readonly string Haarcascade_Upperbody_Path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "haarcascade_upperbody.xml");
